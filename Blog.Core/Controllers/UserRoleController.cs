...
using Blog.Core.FrameWork.Services;
...
namespace Blog.Core.Controllers
{
    ...
    public class UserRoleController : Controller
    {
        ...
        public UserRoleController(IUserInfoServices userInfoServices, IUserRoleServices userRoleServices, IRoleServices roleServices)
        {
        ...
        {
            var model = await UserInfoServices.SaveUserInfo(loginName, loginPWD);
            return Ok(new
            {
                success = true,
                data = model
